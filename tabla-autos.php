...
<div class="container"> <!-- Apertura del container-->
	...
	<table id="tabla_datos" class="table table-bordered">
		...
		<tr>
			...
			<td><a class="btn btn-warning" href="autos-update.php?id=<?=$row['id']?>">Actualizar</a> 
				<a class="btn btn-danger" href="autos-delete.php?id=<?=$row['id']?>">ELIMINAR</a></td>
		</tr>
		<?php 
				}
