...
<head>
    ...
    <title>ACTUALIZAR ESTAO DEL AUTO<?=$reg['nombre']?> </title>
...
<h1 class="text-success">INGRESE LOS DATOS DEL USUARIO A ACTUALIZAR</h1>
<br>
...
<div class="container">
    <div class="row">
        <div class="col-md-6">
            ...
            <form action="update_autos.php" method="post" id="formulario" required>
